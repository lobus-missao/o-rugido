...
Ref: specs/02-data-model.md, specs/03-ingestion-sources.md, specs/11-audit-observability.md
...
import news_radar.sources as src_module
import news_radar.editorial as ed_module
...
def test_upsert_source_defaults_razoaveis(monkeypatch):
    """upsert_source com apenas name e url usa source_type='rss', scope='brasil', trust=0.5."""
...
def test_sources_e_editorial_smoke_postgres(monkeypatch):
    ...
    import importlib
    import news_radar.sources as src_real
    import news_radar.editorial as ed_real
